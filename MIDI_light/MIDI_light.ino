/*
  ...
  Adapted for this prototype by Misael Sánchez 2022. 
...
/////////////////////////////////////////////
// BUTTONS
const int N_BUTTONS = 8; //*  total numbers of buttons. 12 by default
...
const int POT_ARDUINO_PIN[N_POTS] = {A4,A5}; //* pins of each pot connected straight to the Arduino
...
const int varThreshold = 1; //* Threshold for the potentiometer signal variation
